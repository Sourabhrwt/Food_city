      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div
            ...
            onClick={showCart}
          >
            <MdShoppingBasket className="text-textColor text-2xl hover:text-textColor cursor-pointer" />
          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 shadow-xl flex flex-col absolute top-10 right-0 rounded-lg bg-grey-50 "
              >
                {user && user.email === "sourabhrwt8126544591@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
